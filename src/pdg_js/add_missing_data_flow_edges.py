...
def add_missing_data_flow_edges(pdg: Node, add_basic_df_edges: bool, benchmarks: Optional[dict] = None) -> int:
    """
    ...
    Parameters:
        ...
        add_basic_df_edges: whether to add the basic data flow edges;
                            ...
                            (much better performance for larger, obfuscated extensions)
